...
<xsl:stylesheet 
	...
	<xsl:template match="/">
		<oai_dc:dc xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/" 
			...
			<!-- dc.title -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='setspec']/doc:element[@name='uppsok']/doc:element/doc:field[@name='value']">
				<dc:uppsok><xsl:value-of select="." /></dc:uppsok>
			</xsl:for-each>
			<!-- dc.title -->
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='contributor']/doc:element[@name='department']/doc:element[@name='swe']/doc:field[@name='value']">
			...
			<!-- dc.type -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='type']/doc:element[@name='uppsok']/doc:element/doc:field[@name='value']">
